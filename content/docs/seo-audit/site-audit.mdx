...
整站稽核（Site Audit）檢查的是**網站層級**的設定，而非單一頁面。這些設定影響整個網站的 SEO 表現，是 SEO 的基礎架構。
...
1. 進入「AI Search 稽核」頁面
2. 切換到「整站」分頁
3. 確認要稽核的網站（會顯示目前品牌的網址）
4. 點擊「執行整站稽核」
5. 等待檢查完成（通常 1-5 分鐘）
...
<Cards>
  <Card title="執行單頁稽核" href="/docs/seo-audit/first-audit" />
